...
public class SchemaService {
    ...
    final static int cacheCapacity = 100;
    ...
    public static class SchemaServiceBuilder {
        ...
        public SchemaServiceBuilder getRegisterationAndCompatibilityService(String topic, String serdeFormat, RestUtils restUtils,
